...
module design_1
  ...
  wire [31:0]pl_rd_bram_0_Bram_rtl_ADDR;
  wire pl_rd_bram_0_Bram_rtl_CLK;
  wire [31:0]pl_rd_bram_0_Bram_rtl_DIN;
  wire [31:0]pl_rd_bram_0_Bram_rtl_DOUT;
  wire pl_rd_bram_0_Bram_rtl_EN;
  wire pl_rd_bram_0_Bram_rtl_RST;
  wire [3:0]pl_rd_bram_0_Bram_rtl_WE;
  wire pl_rd_bram_0_hsync;
  wire pl_rd_bram_0_is_display_active;
  wire [23:0]pl_rd_bram_0_rgb;
  wire pl_rd_bram_0_vsync;
  ...
  wire [23:0]rgb_to_rbg_0_rbg_out;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(pl_rd_bram_0_Bram_rtl_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(pl_rd_bram_0_Bram_rtl_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(pl_rd_bram_0_Bram_rtl_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(pl_rd_bram_0_Bram_rtl_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(pl_rd_bram_0_Bram_rtl_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(pl_rd_bram_0_Bram_rtl_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(pl_rd_bram_0_Bram_rtl_WE));
  design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(processing_system7_0_FCLK_CLK0),
        .clk_out1(clk_wiz_0_clk_out1),
        .reset(xlconstant_0_dout));
  design_1_pl_rd_bram_0_0 pl_rd_bram_0
       (.bram_addr(pl_rd_bram_0_Bram_rtl_ADDR),
        .bram_clk(pl_rd_bram_0_Bram_rtl_CLK),
        .bram_data(pl_rd_bram_0_Bram_rtl_DOUT),
        .bram_en(pl_rd_bram_0_Bram_rtl_EN),
        .bram_rst(pl_rd_bram_0_Bram_rtl_RST),
        .bram_wdata(pl_rd_bram_0_Bram_rtl_DIN),
        .bram_we(pl_rd_bram_0_Bram_rtl_WE),
        .hsync(pl_rd_bram_0_hsync),
        .is_display_active(pl_rd_bram_0_is_display_active),
        .pixel_clk(clk_wiz_0_clk_out1),
        .push_button_0(push_button_0_0_1),
        .rgb(pl_rd_bram_0_rgb),
  ...
  design_1_rgb2dvi_0_0 rgb2dvi_0
       (.PixelClk(clk_wiz_0_clk_out1),
        ...
        .vid_pHSync(pl_rd_bram_0_hsync),
        .vid_pVDE(pl_rd_bram_0_is_display_active),
        .vid_pVSync(pl_rd_bram_0_vsync));
  design_1_rgb_to_rbg_0_0 rgb_to_rbg
       (.rbg_out(rgb_to_rbg_0_rbg_out),
        .rgb_in(pl_rd_bram_0_rgb));
