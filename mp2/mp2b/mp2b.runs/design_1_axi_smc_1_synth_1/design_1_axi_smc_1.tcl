...
read_ip -quiet d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1 -new_name design_1_axi_smc_1 -ip [get_ips design_1_axi_smc_1]]
...
if { [catch {
  file copy -force D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1/design_1_axi_smc_1.dcp d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1/design_1_axi_smc_1_stub.v d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1/design_1_axi_smc_1_stub.vhdl d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1/design_1_axi_smc_1_sim_netlist.v d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.runs/design_1_axi_smc_1_synth_1/design_1_axi_smc_1_sim_netlist.vhdl d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.ip_user_files/ip/design_1_axi_smc_1]} {
  catch { 
    file copy -force d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.v D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.ip_user_files/ip/design_1_axi_smc_1
  }
}

if {[file isdir D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.ip_user_files/ip/design_1_axi_smc_1]} {
  catch { 
    file copy -force d:/Code/UIUC-ECE527/mp2/mp2b/mp2b.srcs/sources_1/bd/design_1/ip/design_1_axi_smc_1/design_1_axi_smc_1_stub.vhdl D:/Code/UIUC-ECE527/mp2/mp2b/mp2b.ip_user_files/ip/design_1_axi_smc_1
  }
}
