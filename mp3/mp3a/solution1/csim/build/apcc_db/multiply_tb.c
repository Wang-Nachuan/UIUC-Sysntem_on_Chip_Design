...
void multiply(signed int (*)[100], signed int (*)[100], signed int (*)[100], signed int , signed int , signed int , signed int , signed int , signed int );
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multiply([100 x i32]* %%1, [100 x i32]* %%2, [100 x i32]* %%3, i32 %%7, i32 %%10, i32 %%10, i32 %%13, i32 %%7, i32 %%13) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_356_count);
  multiply(llvm_cbe_tmp__18, llvm_cbe_tmp__19, llvm_cbe_tmp__20, llvm_cbe_tmp__24, llvm_cbe_tmp__27, llvm_cbe_tmp__27, llvm_cbe_tmp__30, llvm_cbe_tmp__24, llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__24);
printf("\nArgument  = 0x%X",llvm_cbe_tmp__27);
printf("\nArgument  = 0x%X",llvm_cbe_tmp__27);
