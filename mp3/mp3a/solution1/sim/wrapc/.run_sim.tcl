...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multiply.autotvin.dat"
	set constFileTvOut       "multiply.autotvout.dat"
	set constFileHdlTvIn     "multiply.autohdltvin.dat"
	set constFileHdlTvOut    "multiply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
