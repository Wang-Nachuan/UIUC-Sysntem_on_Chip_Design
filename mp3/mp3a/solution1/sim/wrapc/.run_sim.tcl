...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Applications/Vivado/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Applications/Vivado/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Applications/Vivado/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Applications/Vivado/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Applications/Vivado/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multiply_a23.autotvin.dat"
	set constFileTvOut       "multiply_a23.autotvout.dat"
	set constFileHdlTvIn     "multiply_a23.autohdltvin.dat"
	set constFileHdlTvOut    "multiply_a23.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
