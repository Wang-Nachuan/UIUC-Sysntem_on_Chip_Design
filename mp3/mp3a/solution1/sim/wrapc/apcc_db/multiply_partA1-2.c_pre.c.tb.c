...
void multiply_a12(signed int (*llvm_cbe_A)[100], signed int (*llvm_cbe_B)[100], signed int (*llvm_cbe_C)[100], signed int llvm_cbe_mA, signed int llvm_cbe_nA, signed int llvm_cbe_mB, signed int llvm_cbe_nB, signed int llvm_cbe_mC, signed int llvm_cbe_nC);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge11 = phi i32 [ 0, %%0 ], [ %%19, %%.preheader5..preheader5.split_crit_edge  for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_storemerge11_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%storemerge11 to i64, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_29_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = add nsw i32 %%storemerge11, 1, !dbg !5 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_68_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge16.us = phi i32 [ %%6, %%.us-lcssa.us.us ], [ 0, %%.preheader5  for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_storemerge16_2e_us_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i32 %%storemerge16.us to i64, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_37_count);
  llvm_cbe_tmp__2 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge16_2e_us);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds [100 x i32]* %%C, i64 %%2, i64 %%4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_38_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add nsw i32 %%storemerge16.us, 1, !dbg !5 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_40_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge24.us.us = phi i32 [ %%9, %%8 ], [ 0, %%.preheader.us  for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_storemerge24_2e_us_2e_us_count);
...
llvm_cbe_tmp__17:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge24.us.us, 1, !dbg !5 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_50_count);
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = sext i32 %%storemerge24.us.us to i64, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_58_count);
  llvm_cbe_tmp__6 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge24_2e_us_2e_us);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds [100 x i32]* %%A, i64 %%2, i64 %%11, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_59_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = load i32* %%12, align 4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__8 = (unsigned int )*llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds [100 x i32]* %%B, i64 %%11, i64 %%4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_61_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = load i32* %%14, align 4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_62_count);
  llvm_cbe_tmp__10 = (unsigned int )*llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = mul nsw i32 %%15, %%13, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_63_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%5, align 4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__12 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = add nsw i32 %%17, %%16, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_65_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%18, i32* %%5, align 4, !dbg !2 for 0x%I64xth hint within @multiply_a12  --> \n", ++aesl_llvm_cbe_66_count);
