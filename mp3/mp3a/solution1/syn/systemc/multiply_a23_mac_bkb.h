...
// ==============================================================
#ifndef __multiply_a23_mac_bkb__HH__
#define __multiply_a23_mac_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(multiply_a23_mac_bkb) {
    ...
    SC_CTOR(multiply_a23_mac_bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
