# 1 "mp3a/multiply_partA1-1.c"
# 1 "mp3a/multiply_partA1-1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "mp3a/multiply_partA1-1.c" 2

void multiply_a11(int A[100][100], int B[100][100], int C[100][100], int mA, int nA, int mB, int nB, int mC, int nC) {_ssdm_SpecArrayDimSize(A, 100);_ssdm_SpecArrayDimSize(B, 100);_ssdm_SpecArrayDimSize(C, 100);
 for (int i = 0; i < 100; i++) {
  for (int j = 0; j < 100; j++) {
   for (int k = 0; k < 100; k++) {
    if (i < mC && j < nC && k < nA) {
