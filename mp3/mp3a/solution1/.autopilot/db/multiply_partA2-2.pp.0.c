# 1 "mp3a/multiply_partA2-2.c"
# 1 "mp3a/multiply_partA2-2.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "mp3a/multiply_partA2-2.c" 2

void multiply_a22(int A[100][100], int B[100][100], int C[100][100], int mA, int nA, int mB, int nB, int mC, int nC) {_ssdm_SpecArrayDimSize(A, 100);_ssdm_SpecArrayDimSize(B, 100);_ssdm_SpecArrayDimSize(C, 100);
 for (int i = 0; i < 100; i++) {
