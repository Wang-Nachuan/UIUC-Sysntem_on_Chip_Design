...
`define AUTOTB_TVIN_A  "./c.multiply.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.multiply.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.multiply.autotvin_C.dat"
`define AUTOTB_TVIN_nA  "./c.multiply.autotvin_nA.dat"
`define AUTOTB_TVIN_mC  "./c.multiply.autotvin_mC.dat"
`define AUTOTB_TVIN_nC  "./c.multiply.autotvin_nC.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.multiply.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.multiply.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.multiply.autotvin_C.dat"
`define AUTOTB_TVIN_nA_out_wrapc  "./rtl.multiply.autotvin_nA.dat"
`define AUTOTB_TVIN_mC_out_wrapc  "./rtl.multiply.autotvin_mC.dat"
`define AUTOTB_TVIN_nC_out_wrapc  "./rtl.multiply.autotvin_nC.dat"
`define AUTOTB_TVOUT_C  "./c.multiply.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.multiply.autotvout_C.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 27;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4020201;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.multiply.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.multiply.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.multiply.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.multiply.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.multiply.autotvout_C.dat with impl_rtl.multiply.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
