...
`define AUTOTB_DUT      multiply_a23
`define AUTOTB_DUT_INST AESL_inst_multiply_a23
`define AUTOTB_TOP      apatb_multiply_a23_top
`define AUTOTB_LAT_RESULT_FILE "multiply_a23.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "multiply_a23.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_multiply_a23_top
...
`define AUTOTB_TVIN_A  "./c.multiply_a23.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.multiply_a23.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.multiply_a23.autotvin_C.dat"
`define AUTOTB_TVIN_nA  "./c.multiply_a23.autotvin_nA.dat"
`define AUTOTB_TVIN_mC  "./c.multiply_a23.autotvin_mC.dat"
`define AUTOTB_TVIN_nC  "./c.multiply_a23.autotvin_nC.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.multiply_a23.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.multiply_a23.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.multiply_a23.autotvin_C.dat"
`define AUTOTB_TVIN_nA_out_wrapc  "./rtl.multiply_a23.autotvin_nA.dat"
`define AUTOTB_TVIN_mC_out_wrapc  "./rtl.multiply_a23.autotvin_mC.dat"
`define AUTOTB_TVIN_nC_out_wrapc  "./rtl.multiply_a23.autotvin_nC.dat"
`define AUTOTB_TVOUT_C  "./c.multiply_a23.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.multiply_a23.autotvout_C.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 27;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 3270201;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.multiply_a23.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.multiply_a23.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.multiply_a23.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.multiply_a23.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.multiply_a23.autotvout_C.dat with impl_rtl.multiply_a23.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
