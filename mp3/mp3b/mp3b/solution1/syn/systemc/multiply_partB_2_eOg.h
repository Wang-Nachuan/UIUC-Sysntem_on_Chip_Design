...
// ==============================================================
#ifndef __multiply_partB_2_eOg__HH__
#define __multiply_partB_2_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(multiply_partB_2_eOg) {
    ...
    SC_CTOR(multiply_partB_2_eOg):  simcore_mac_0_U ("simcore_mac_0_U") {
