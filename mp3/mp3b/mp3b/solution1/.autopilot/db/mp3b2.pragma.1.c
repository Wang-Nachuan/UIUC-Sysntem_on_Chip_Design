...
void multiply_partB_2(int A[100][100], int B[100][100], int C[100][100], int mA, int nA, int mB, int nB, int mC, int nC) {_ssdm_SpecArrayDimSize(A, 100);_ssdm_SpecArrayDimSize(B, 100);_ssdm_SpecArrayDimSize(C, 100);
