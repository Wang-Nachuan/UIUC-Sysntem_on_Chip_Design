...
set C_modelArgList {
	...
	{ weights_0 float 32 regular {array 150 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenet_top_fadd_32bkb_U7", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenet_top_fmul_32cud_U8", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1383325", "Max" : "1383325"}
	, {"Name" : "Interval", "Min" : "1383325", "Max" : "1383325"}
]}
...
set Spec2ImplPortList { 
	...
	weights_0 { ap_memory {  { weights_0_address0 mem_address 1 8 }  { weights_0_ce0 mem_ce 1 1 }  { weights_0_q0 mem_dout 0 32 } } }
