...
set C_modelArgMapList {[ 
	{ "Name" : "weights1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ weights1_address0 sc_out sc_lv 8 signal 0 } 
	{ weights1_ce0 sc_out sc_logic 1 signal 0 } 
	{ weights1_q0 sc_in sc_lv 32 signal 0 } 
	{ weights1_buf_0_address0 sc_out sc_lv 8 signal 1 } 
	{ weights1_buf_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ weights1_buf_0_we0 sc_out sc_logic 1 signal 1 } 
	{ weights1_buf_0_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
