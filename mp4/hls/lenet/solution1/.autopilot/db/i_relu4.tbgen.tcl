...
set C_modelName {i_relu4}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r float 32 regular {array 400 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenet_top_fcmp_32dEe_U34", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 9 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 32 }  { input_r_q0 mem_dout 0 32 } } }
}
