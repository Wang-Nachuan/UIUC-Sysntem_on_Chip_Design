...
set C_modelName {i_relu2}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r float 32 regular {array 1176 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lenet_top_fcmp_32dEe_U21", "Parent" : "0"}]}
