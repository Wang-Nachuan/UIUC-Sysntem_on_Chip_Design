...
set C_modelArgMapList {[ 
	{ "Name" : "weights3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ weights3_address0 sc_out sc_lv 12 signal 0 } 
	{ weights3_ce0 sc_out sc_logic 1 signal 0 } 
	{ weights3_q0 sc_in sc_lv 32 signal 0 } 
	{ weights3_buf_address0 sc_out sc_lv 12 signal 1 } 
	{ weights3_buf_ce0 sc_out sc_logic 1 signal 1 } 
	{ weights3_buf_we0 sc_out sc_logic 1 signal 1 } 
	{ weights3_buf_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5985", "Max" : "5985"}
	, {"Name" : "Interval", "Min" : "5985", "Max" : "5985"}
]}
