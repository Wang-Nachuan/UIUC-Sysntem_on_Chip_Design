...
set C_modelArgMapList {[ 
	{ "Name" : "weights5", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ weights5_address0 sc_out sc_lv 16 signal 0 } 
	{ weights5_ce0 sc_out sc_logic 1 signal 0 } 
	{ weights5_q0 sc_in sc_lv 32 signal 0 } 
	{ weights5_buf_address0 sc_out sc_lv 16 signal 1 } 
	{ weights5_buf_ce0 sc_out sc_logic 1 signal 1 } 
	{ weights5_buf_we0 sc_out sc_logic 1 signal 1 } 
	{ weights5_buf_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "119281", "Max" : "119281"}
	, {"Name" : "Interval", "Min" : "119281", "Max" : "119281"}
]}
