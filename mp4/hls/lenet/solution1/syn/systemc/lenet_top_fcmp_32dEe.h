...
// ==============================================================
#ifndef __lenet_top_fcmp_32dEe__HH__
#define __lenet_top_fcmp_32dEe__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_top_fcmp_32dEe) {
    ...
    SC_CTOR(lenet_top_fcmp_32dEe):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
