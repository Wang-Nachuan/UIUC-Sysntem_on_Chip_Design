...
architecture behav of st_output is 
    ...
    signal icmp_ln193_fu_101_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal output_buf_load_reg_137 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal i_0_reg_79 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln194_fu_113_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln194_1_fu_90_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((m_axi_output_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                i_0_reg_79 <= i_reg_127;
            elsif ((not(((m_axi_output_r_AWREADY = ap_const_logic_0) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                output_buf_load_reg_137 <= output_buf_q0;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_output_r_AWREADY, m_axi_output_r_WREADY, m_axi_output_r_BVALID, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state2, icmp_ln193_fu_101_p2)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((m_axi_output_r_AWREADY = ap_const_logic_0) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln193_fu_101_p2 = ap_const_lv1_1))) then
    ...
    i_fu_107_p2 <= std_logic_vector(unsigned(i_0_reg_79) + unsigned(ap_const_lv4_1));
    icmp_ln193_fu_101_p2 <= "1" when (i_0_reg_79 = ap_const_lv4_A) else "0";
    ...
    m_axi_output_r_AWADDR <= zext_ln194_1_fu_90_p1(32 - 1 downto 0);
    ...
    m_axi_output_r_AWVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_output_r_AWREADY)
    begin
        if ((not(((m_axi_output_r_AWREADY = ap_const_logic_0) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    m_axi_output_r_WDATA <= output_buf_load_reg_137;
    ...
    m_axi_output_r_WVALID_assign_proc : process(m_axi_output_r_WREADY, ap_CS_fsm_state4)
    begin
        if (((m_axi_output_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    output_buf_address0 <= zext_ln194_fu_113_p1(4 - 1 downto 0);
    ...
    zext_ln194_1_fu_90_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(output_offset),64));
    zext_ln194_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_79),64));
end behav;
