...
output  [3:0] output_buf_address0;
...
wire   [0:0] icmp_ln193_fu_101_p2;
reg   [31:0] output_buf_load_reg_137;
wire    ap_CS_fsm_state3;
reg   [3:0] i_0_reg_79;
wire   [63:0] zext_ln194_fu_113_p1;
wire   [63:0] zext_ln194_1_fu_90_p1;
reg   [7:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((m_axi_output_r_WREADY == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        i_0_reg_79 <= i_reg_127;
    end else if ((~((m_axi_output_r_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_0_reg_79 <= 4'd0;
    end
end
...
always @ (*) begin
    if ((~((m_axi_output_r_AWREADY == 1'b0) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln193_fu_101_p2 == 1'd1))) begin
...
assign i_fu_107_p2 = (i_0_reg_79 + 4'd1);

assign icmp_ln193_fu_101_p2 = ((i_0_reg_79 == 4'd10) ? 1'b1 : 1'b0);
...
assign m_axi_output_r_AWADDR = zext_ln194_1_fu_90_p1;
...
assign m_axi_output_r_WDATA = output_buf_load_reg_137;
...
assign output_buf_address0 = zext_ln194_fu_113_p1;

assign zext_ln194_1_fu_90_p1 = output_offset;

assign zext_ln194_fu_113_p1 = i_0_reg_79;
