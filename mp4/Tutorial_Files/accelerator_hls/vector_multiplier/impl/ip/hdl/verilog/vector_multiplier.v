...
(* CORE_GENERATION_INFO="vector_multiplier,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=79,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=3,HLS_SYN_FF=1994,HLS_SYN_LUT=2280,HLS_VERSION=2019_1}" *)
...
reg   [0:0] icmp_ln7_reg_274_pp0_iter2_reg;
reg    DATA_C_blk_n_B;
...
reg   [0:0] icmp_ln7_reg_274_pp0_iter1_reg;
wire   [6:0] i_fu_231_p2;
reg    ap_enable_reg_pp0_iter0;
reg  signed [31:0] DATA_A_addr_read_reg_283;
reg  signed [31:0] DATA_B_addr_read_reg_288;
wire   [31:0] mul_ln9_fu_237_p2;
reg   [31:0] mul_ln9_reg_293;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
wire   [63:0] empty_4_fu_195_p1;
wire   [63:0] empty_5_fu_205_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state9) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == DATA_C_AWREADY) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln7_fu_225_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln7_reg_274 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln7_reg_274_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln7_reg_274 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DATA_A_RREADY = 1'b1;
    end else begin
        DATA_A_RREADY = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln7_reg_274 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == DATA_C_AWREADY) & (1'b1 == ap_CS_fsm_state8))) begin
        DATA_C_AWVALID = 1'b1;
    end else begin
        DATA_C_AWVALID = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == DATA_C_BVALID) & (1'b1 == ap_CS_fsm_state17))) begin
        DATA_C_BREADY = 1'b1;
    end else begin
        DATA_C_BREADY = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln7_reg_274_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        DATA_C_WVALID = 1'b1;
    end else begin
        DATA_C_WVALID = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln7_reg_274_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if ((icmp_ln7_fu_225_p2 == 1'd1)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln7_fu_225_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln7_fu_225_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
...
assign DATA_A_ARADDR = empty_5_fu_205_p1;

assign DATA_B_ARADDR = empty_4_fu_195_p1;

assign DATA_C_AWADDR = empty_fu_215_p1;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == DATA_B_RVALID) & (icmp_ln7_reg_274 == 1'd0)) | ((1'b0 == DATA_A_RVALID) & (icmp_ln7_reg_274 == 1'd0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == DATA_B_RVALID) & (icmp_ln7_reg_274 == 1'd0)) | ((1'b0 == DATA_A_RVALID) & (icmp_ln7_reg_274 == 1'd0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == DATA_B_RVALID) & (icmp_ln7_reg_274 == 1'd0)) | ((1'b0 == DATA_A_RVALID) & (icmp_ln7_reg_274 == 1'd0)))));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = (((1'b0 == DATA_B_RVALID) & (icmp_ln7_reg_274 == 1'd0)) | ((1'b0 == DATA_A_RVALID) & (icmp_ln7_reg_274 == 1'd0)));
end

assign ap_block_state11_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state12_io = ((1'b0 == DATA_C_WREADY) & (icmp_ln7_reg_274_pp0_iter2_reg == 1'd0));
end

assign ap_block_state12_pp0_stage0_iter3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_io = ((1'b0 == DATA_B_ARREADY) | (1'b0 == DATA_A_ARREADY));
end
...
assign empty_4_fu_195_p1 = b3_reg_246;

assign empty_5_fu_205_p1 = a1_reg_251;

assign empty_fu_215_p1 = c5_reg_241;

assign i_fu_231_p2 = (i_0_reg_154 + 7'd1);

assign icmp_ln7_fu_225_p2 = ((i_0_reg_154 == 7'd64) ? 1'b1 : 1'b0);

assign mul_ln9_fu_237_p2 = ($signed(DATA_A_addr_read_reg_283) * $signed(DATA_B_addr_read_reg_288));
