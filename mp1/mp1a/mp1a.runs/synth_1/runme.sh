...
HD_PWD='D:/Code/UIUC-ECE527/mp1/mp1a/mp1a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1a_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp1a_rtl.tcl
