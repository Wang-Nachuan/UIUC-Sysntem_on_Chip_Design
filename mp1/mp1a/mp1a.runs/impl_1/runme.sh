...
HD_PWD='D:/Code/UIUC-ECE527/mp1/mp1a/mp1a.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1a_rtl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mp1a_rtl.tcl -notrace
