...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { ld4_b }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { ld5_b }]; #IO_0_35 Sch=led5_b
