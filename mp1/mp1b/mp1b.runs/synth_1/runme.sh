...
HD_PWD='D:/Code/UIUC-ECE527/mp1/mp1b/mp1b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1b_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp1b_rtl.tcl
