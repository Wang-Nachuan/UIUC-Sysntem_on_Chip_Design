...
HD_PWD='D:/Code/UIUC-ECE527/mp1/mp1b/mp1b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1b_rtl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mp1b_rtl.tcl -notrace
